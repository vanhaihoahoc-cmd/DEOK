    ...
    <nav className="sticky top-0 z-50 bg-[#004444] border-b border-[#005555] shadow-2xl px-4 md:px-6 py-2 md:py-3 flex items-center justify-between">
      ...
      >
        ...
        <div className="flex flex-col">
          <span className="text-sm md:text-xl font-black tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-[#BF953F] via-[#FCF6BA] to-[#B38728] uppercase leading-tight">
            VANHAI
          </span>
          <span className="text-xs md:text-sm font-black tracking-tighter text-[#00f5ff] uppercase leading-none">
            EDUCATION
          </span>
        </div>
      </div>
